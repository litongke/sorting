 ...
 * @since 2022-01-07
 */
public interface IJjPageService extends IService<JjSgjResultParam> {
List<JjSgjResultParam> getJjPageSgjList(User user);
void confirmJJSGJ(User user,List<JjSgjResultParam> jjSgjResultParams);
}
